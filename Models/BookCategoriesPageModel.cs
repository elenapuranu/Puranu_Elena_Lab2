...
namespace Puranu_Elena_Lab2.Models
{
    public class BookCategoriesPageModel : PageModel
    {

        public List<AssignedCategoryData> AssignedCategoryDataList;
        public void PopulateAssignedCategoryData(Puranu_Elena_Lab2Context context,
        Book book)
        {
        ...
        public void UpdateBookCategories(Puranu_Elena_Lab2Context context,
